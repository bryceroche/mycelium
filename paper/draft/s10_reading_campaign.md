## 10. The Reading Campaign (the library and the librarian)

§9 showed the discipline killing hypotheses; this section shows it
building something. The campaign's object was the register wall of §8:
...
and its first day is the §11 annotator-paragraph made concrete: the
...
**The completion.** The campaign then measured its own end: Fig. 9-a's
saturation curve (~23 census problems recovered for the first ~114
annotated uniques, ~0 marginal for the next 74 at the same
distribution — with the §11 scope drawn on the plot). The registry's
...
named in §11. The books did not just teach the parser to read; they
