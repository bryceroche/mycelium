...
never enters the decision path (Fig. 1; §7). At freeze it certifies 912
...
(§11):* 1.0000 on 912 is a zero-numerator bound near a tenth of a
...
Its live exhibit is §7.4's standing bet: a falsifiable, pre-registered
...
replacement. *Limit (§11):* every generation comparison is a single
...
an open slope. *Limit (§11):* saturation is measured for one
...
one examiner out of the acceptance path (§7.4). We offer these as
engineering laws for any deployed system that watches itself with
trained instruments. *Limit (§11):* all three were established at this
...
(§11) the battery refused the authors' expectations, and those
