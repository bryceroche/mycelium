"""
C1-A: Boundary Detector Training

Per-token binary classification for span boundaries.
"""
...
def main():
    ...
    print(f"\nStarting C1-A training for {args.epochs} epochs...")
    ...
    print(f"\nC1-A Training Complete!")
    print(f"Best F1: {best_f1:.4f}")
    print(f"Checkpoint saved to {output_path}")

    # Save final results
    results = {"best_f1": best_f1, "final_epoch": epoch}
