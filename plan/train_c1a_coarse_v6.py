"""
C1-A Coarse Boundary Window Detection v6

Changes from v5:
- LaTeX preprocessing applied to problem_text before tokenization
- Data already cleaned (mislabeled negatives removed)
- Track F1@0.7 for evaluation
"""
...
class C1ACoarseDataset(Dataset):
    """Dataset for coarse boundary window detection with LaTeX preprocessing."""
...
def main():
    ...
    print(f"\nStarting C1-A Coarse v6 training: {len(train_dataset)} train, {len(val_dataset)} val")
