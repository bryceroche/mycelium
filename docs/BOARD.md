...
| THE DECISION POINT — REPRICED 2026-08-04: **the commit head IS a working trained grading signal (mass AUC 0.941, slot-grain, held-out bigtest, one 4k bench fire — register-clean by construction)** after 4 cheap nulls; OWED: answer-grain graduation read + wild-ledger pricing per the standing rule | Bryce | the word; answer-grain read first | 2026-08-04 |
