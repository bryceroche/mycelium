...
| VOTE-SEMANTICS WINDOW items: (1) permuted_view <=3-sentence collapse (landmine, not live); (2) **THE DIGEST VOTE (08-04): quorum over canonical digests — 18% answer-coincidence class measured (different graphs, same answer); strictly harsher cert, zero inference cost** | bench | the window — never mid-campaign silently | 2026-08-04 |
