...
| DUP-ARGS DIET (ranked first; 53% live baseline; settle = mechanism after-read): design now carries THREE blind calls — wetting ordering + DOSE ARM (#112: two fractions, non-monotone test) | bench | the word; the sharpest-instrumented fire ever staged | 2026-07-31 |
