...
|---|---|---|---|
| **SURFACE AUGMENTATION — table v1 LIVE** (mycelium/aug_table.py; 23/23 seeds licensed; coverage: mul 30/add 20/div 5/pct 25/sel 80% word-share) — NEXT TRANCHE: the SYMBOLIC class (dominant uncovered mass every family) + skipped word-families, pen tranches through the gate → coverage bar → dose arms. After-read: binding + SLOT EMISSION | fresh hand | table tranche 2 (symbolic class first) | 2026-08-01 |
