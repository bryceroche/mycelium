...
EXECUTION_MODES = ["decompose", "formula", "procedure", "dsl"]
...
class StepIOSchema:
    ...
    # Execution mode: "decompose" | "formula" | "procedure"
    execution_mode: str = "decompose"
    ...
    def from_json(cls, json_str: str) -> "StepIOSchema":
        ...
        try:
            ...
            return cls(
                ...
                execution_mode=d.get("execution_mode", "decompose"),
