"""book3_tranche15.py — BOOK 3, TRANCHE 15: THE FIRST OP-GRAIN TRANCHE
...
T1 = [
 (330, 300, D + "a, b, c, d. a is 10. b is 5. a times b equals c. When c is divided by 2, the quotient is d. What is d?"),
 (360, 300, D + "a, b, c. a is 200. When a is divided by 5, the quotient is b. a plus b equals c. What is c?"),
 (369, 300, D + "a, b, c, d. a is 55. When a is divided by 5, the quotient is b. c is 11. b times c equals d. What is d?"),
 (375, 300, D + "a, b, c. a is 10. b is 3. a exceeds c by b. What is c?"),
 (385, 300, D + "a, b, c, d, e, f, g. a is 36. b is 27. a plus b equals c. e is 20. c exceeds d by e. f is 60. f exceeds g by d. What is g?"),
 (394, 300, D + "a, b. a is 8. a times a equals b. What is b?"),
]
OP_SPANS = {   # per lane_idx: (op, cue substring in the RAW text)
 330: [("mul", "doubled"), ("fr", "divided by 5")],
 360: [("fr", "20\\%"), ("addf", "farther than")],
 369: [("sq", "22^2"), ("mul", "\\times")],
 375: [("sq", "\\sqrt{36"), ("addf", "36+64")],
 385: [("addf", "take both"), ("addf", "neither mathematics nor physics")],
 394: [("fr", "divided by")],
}
...
for ti, (li, m, dia) in enumerate(T1):
    ...
    texts = [dia] + [permuted_view(dia, 99980 + 100*ti + k) for k in range(1, 5)]
    votes = []
    ...
    if ok:
        banked.append(dict(lane_idx=li, raw=raw, dialect=dia, answer=gold,
                           m=m, lane=row["lane"], book=3, tranche=15,
