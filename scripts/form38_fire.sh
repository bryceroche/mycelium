...
env CK=.cache/g38_form.safetensors OUT_JSON=.cache/calib_g38.json CK_OUT=.cache/g38_form_refold.safetensors $PY scripts/calibrated_rite.py || echo "[g38] NO-HEADROOM"
echo "== g38 REFOLD scan =="
