...
peritem={}
for name,ck in (("g22",".cache/g22.safetensors"),("vfull",".cache/g24_vfull.safetensors"),("v120",".cache/g24_v120.safetensors")):
...
for name in [n for n in peritem if n in agg]:
...
json.dump(peritem,open('.cache/flip_phaseB.json','w'),indent=0)
print("[saved] .cache/flip_phaseB.json")
