"""book3_tranche9.py — BOOK 3, TRANCHE 9: THE FIRST OP-GRAIN TRANCHE
...
T1 = [
 (158, 300, D + "a, b, c, d. a is 9. a times a equals b. c is 10. b exceeds d by c. What is d?"),
 (175, 300, D + "a, b, c, d, e, f. a is 3. b is 2. a plus b equals c. d is 45. When d is divided by 5, the quotient is e. e times a equals f. What is f?"),
 (182, 300, D + "a, b, c, d, e, f, g, h. a is 27. When a is divided by 3, the quotient is b. c is 1. d is 5. e is 3. c plus d equals f. f plus e equals g. b times g equals h. What is h?"),
 (193, 300, D + "a, b, c, d. a is 7. a times a equals b. c is 5. c plus d equals b. What is d?"),
 (196, 300, D + "a, b, c, d. a is 25. When a is divided by 5, the quotient is b. c is 2. b times c equals d. What is d?"),
 (198, 300, D + "a, b, c, d, e. a is 4. b is 3. a times b equals c. d is 2. c times d equals e. What is e?"),
]
OP_SPANS = {   # per lane_idx: (op, cue substring in the RAW text)
 158: [("sq", "perfect square"), ("addf", "less than")],
 175: [("fr", "ratio"), ("addf", "total of 45")],
 182: [("fr", "ratio of red marbles to blue marbles")],
 193: [("sq", "\\sqrt"), ("addf", "5+n")],
 196: [("fr", "\\frac{2}{5}"), ("mul", "of that amount")],
 198: [("mul", "how many orders")],
}
...
for ti, (li, m, dia) in enumerate(T1):
    ...
    texts = [dia] + [permuted_view(dia, 99000 + 100*ti + k) for k in range(1, 5)]
    votes = []
    ...
    if ok:
        banked.append(dict(lane_idx=li, raw=raw, dialect=dia, answer=gold,
                           m=m, lane=row["lane"], book=3, tranche=9,
