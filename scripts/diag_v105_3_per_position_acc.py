...
from mycelium.factor_graph_data_v105_3 import FactorGraphLoaderV105_3
...
K_MAX     = int(getenv("V105_3_K_MAX", "8"))
N_DIGITS  = int(getenv("V105_3_N_DIGITS", "5"))
N_MAX     = int(getenv("V105_3_N_MAX", "16"))
F_MAX     = int(getenv("V105_3_F_MAX", "8"))
WAIST     = int(getenv("V105_3_WAIST", "512"))
N_CODE    = int(getenv("V105_3_CODEBOOK_N", "32"))
N_HEADS   = 16
N_BATCHES = int(getenv("N_BATCHES", "30"))
BATCH     = int(getenv("BATCH", "4"))
CKPT      = getenv("CKPT", ".cache/fg_v105_3_ckpts/v105_3_smoke_final.safetensors")
...
def main():
    print("=== v105.3 per-position diagnostic (LSD-first array layout) ===",
          flush=True)
    ...
    load_ckpt_v105_3(model, CKPT)
    print("loaded ckpt", flush=True)

    train_loader = FactorGraphLoaderV105_3(
