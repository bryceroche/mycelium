...
from scripts.v110_step3_eg_train import load_ckpt_v110_step3_eg as load_ckpt_v110_step3_fb

from mycelium.factor_graph_v110_step3_eg import (
    attach_fg_params_v110_step3_eg as attach_fg_params_v110_step3_fb,
    compile_jit_mcbp_eg as compile_jit_mcbp_fb,
)
...
def main():
    ...
    print(f"  ent_scale value: {float(model.fg_v112_entropy_scale.numpy()[0]):+.4f}")
    print()
