"""gen17_verdict.py — THE ONLY PEN, gen-17 (2026-07-23). Reads the
...
m["gen_id"] = "17"
m["date"] = "2026-07-23"
m["parser_ckpt"] = f".cache/g17_arm{win}.safetensors"
m["corpora"]["train"] = ".cache/gen17_mix.jsonl"
...
m["notes"] = (f"2026-07-23 GEN-17 PROMOTED: g17_arm{win} "
              f"({'flat incumbent' if win == 'F' else 'SGDR restarts'}; "
