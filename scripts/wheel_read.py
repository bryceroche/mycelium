...
if __name__ == "__main__":   # THE MAIN GUARD (2026-09-13): the read-time wheel's spawn pool re-imports this file in each worker; an unguarded body ran the whole read per worker (a spawn storm)
    _main()
