...
env DEV=PCI+AMD ALG2=1 ALG_FTYPES=9 ALG_DUP=1 ALG_HW=512 ALG_WIDE=1 ALG_BREATH=7 ALG_NOTEBOOK=1 ALG_SIXWAVE=1 NB_PERSLOT=1 ALG_BINDBUS=7 ALG_BIND_D=512 BIND_CODES=.cache/bindbus_codes512.npz ALG_ALLOW_PEN_TRAIN=1 ALG_TRAIN=.cache/form_mix12.jsonl ALG_TRAIN_NAME=form12 ALG_BUSGARAGE=2 ALG_SHELF_CIRCLE=2 ALG_ALTMASK=1 SC_EVAL=0 ALG_ALT21=1 ALG_ALT2=1 ST_CKPT=.cache/sharp_port242.safetensors ST_EQ_TOL=1e-5 ST_EQN=8 ST_PING=0 ST_JIT=0 .venv/bin/python3 scripts/step_trainer.py --eqfwd
env DEV=PCI+AMD ALG2=1 ALG_FTYPES=9 ALG_DUP=1 ALG_HW=512 ALG_WIDE=1 ALG_BREATH=7 ALG_NOTEBOOK=1 ALG_SIXWAVE=1 NB_PERSLOT=1 ALG_BINDBUS=7 ALG_BIND_D=512 BIND_CODES=.cache/bindbus_codes512.npz ALG_ALLOW_PEN_TRAIN=1 ALG_TRAIN=.cache/form_mix12.jsonl ALG_TRAIN_NAME=form12 ALG_BUSGARAGE=2 ALG_SHELF_CIRCLE=2 ALG_ALTMASK=1 SC_EVAL=0 ALG_ALT21=1 ALG_ALT2=1 ST_CKPT=.cache/sharp_port242.safetensors ST_EQ_TOL=1e-5 ST_EQN=8 ST_PING=0 ST_JIT=1 .venv/bin/python3 scripts/step_trainer.py --eqfwd
