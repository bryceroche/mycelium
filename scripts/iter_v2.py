"""iter_v2.py — THE CLOSED LOOP v2: SOLVER AS CHECKER (2026-08-25, word
given; the patience covenant's second rung). Checker hierarchy per
        ...
        for it in range(MAX_IT):
            ...
            for li, r in enumerate(sl):
                ...
                live = [(f, present[fi] if fi < len(present) else None)
                        ...
                        if (fi >= len(present) or present[fi] not in amp[li])]
