"""book3_tranche13.py — BOOK 3, TRANCHE 13: THE FIRST OP-GRAIN TRANCHE
...
T1 = [
 (264, 300, D + "a, b, c, d, e, f, g, h. a is 5. a times a equals b. c is 3. c times c equals d. b plus d equals e. f is 4. c times f equals g. e exceeds h by g. What is h?"),
 (268, 300, D + "a, b, c. a is 4. b is 3. a times b equals c. What is c?"),
 (271, 300, D + "a, b, c. a is 7. b is 4. a times b equals c. What is c?"),
 (281, 300, D + "a, b, c, d, e. a is 54. When a is divided by 6, the quotient is b. c is 2. b times c equals d. b times d equals e. What is e?"),
 (283, 300, D + "a, b, c, d. a is 15. When a is divided by 5, the quotient is b. c is 12. b times c equals d. What is d?"),
 (290, 300, D + "a, b, c. a is 12. b is 100. a plus b equals c. What is c?"),
 (291, 300, D + "a, b, c. a is 8. b is 9. a times b equals c. What is c?"),
 (294, 300, D + "a, b, c, d, e, f. a is 213. b is 63. a exceeds c by b. When c is divided by 3, the quotient is d. e is 1. d plus e equals f. What is f?"),
 (297, 300, D + "a, b. a is 24. When a is divided by 2, the quotient is b. What is b?"),
 (299, 300, D + "a, b, c, d. a is 36. b is 4. a times b equals c. d times d equals c. What is d?"),
]
OP_SPANS = {   # per lane_idx: (op, cue substring in the RAW text)
 264: [("sq", "5^2"), ("mul", "3(4)"), ("sq", "3^2")],
 268: [("mul", "combinations")],
 271: [("mul", "multiple of")],
 281: [("fr", "half as wide"), ("mul", "area")],
 283: [("fr", "5$ of these coins"), ("mul", "value of each coin")],
 290: [("addf", "a+b")],
 291: [("mul", "product"), ("sq", "\\sqrt")],
 294: [("mul", "multiples of 3"), ("addf", "between 62 and 215")],
 297: [("mul", "positive multiple")],
 299: [("sq", "\\sqrt"), ("mul", "\\times")],
}
...
for ti, (li, m, dia) in enumerate(T1):
    ...
    texts = [dia] + [permuted_view(dia, 99920 + 100*ti + k) for k in range(1, 5)]
    votes = []
    ...
    if ok:
        banked.append(dict(lane_idx=li, raw=raw, dialect=dia, answer=gold,
                           m=m, lane=row["lane"], book=3, tranche=13,
