...
L = "abcdefghij"
TABLE = json.load(open('.cache/aug_table_v3.json'))["licensed"]
...
res={}
for name,ck in (("g22",".cache/g22.safetensors"),("v120",".cache/g24_v120.safetensors"),("vdup19",".cache/g24_vdup19.safetensors")):
    p=load(ck)
...
json.dump(res,open('.cache/aug_after_v3.json','w'),indent=1)
print("[saved] .cache/aug_after_v3.json — phase B (flip rate, 2b slot emission) rides next")
