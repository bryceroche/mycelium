"""book3_tranche11.py — BOOK 3, TRANCHE 11 (v2-retry): THE FIRST OP-GRAIN TRANCHE
...
T1 = [
 (202, 300, D + "a, b, c, d. a is 5. a times a equals b. c is 4. b plus c equals d. What is d?"),
 (170, 300, D + "a, b, c. a is 21. a times b equals c. c is 189. What is b?"),
 (220, 300, D + "a, b, c, d. a is 2. b is 8. b times b equals c. c plus a equals d. What is d?"),
 (228, 300, D + "a, b, c, d, e, f, g. a is 12. b is 10. a plus b equals c. d is 5. c exceeds e by d. f is 25. f exceeds g by e. What is g?"),
]
...
for ti, (li, m, dia) in enumerate(T1):
    ...
    texts = [dia] + [permuted_view(dia, 99700 + 100*ti + k) for k in range(1, 5)]
    votes = []
    ...
    if ok:
        banked.append(dict(lane_idx=li, raw=raw, dialect=dia, answer=gold,
                           m=m, lane=row["lane"], book=3, tranche=11,
