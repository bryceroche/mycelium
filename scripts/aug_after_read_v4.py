...
L = "abcdefghij"
TABLE = json.load(open('.cache/aug_table_v4.json'))["licensed"]
...
res={}
for name,ck in (("vf14",".cache/g24_vf14.safetensors"),):
    p=load(ck)
...
json.dump(res,open('.cache/aug_after_v4.json','w'),indent=1)
print("[saved] .cache/aug_after_v4.json — phase B (flip rate, 2b slot emission) rides next")
