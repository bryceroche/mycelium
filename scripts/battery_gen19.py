"""battery_gen18.py (generated; charter: band evals + zone column) — THE GEN-17 PROMOTION BATTERY (2026-07-23, fired on
...
GEN = "19"
ENV = {"DEV": "PCI+AMD", "ALG2": "1", "ALG_FTYPES": "8", "ALG_DUP": "1", "ALG_HW": "1024"}
CANDS = {"W": ".cache/g19_pw1024.safetensors"}
...
for cand, ckpt in CANDS.items():
    ...
    sh(".venv/bin/python3 scripts/lattice_member_votes.py",
       {"MEMBER_CKPT": ckpt, "MEMBER_HW": "1024", "MEMBER_DUP": "1",
...
for cand in CANDS:
    for st in ("8000", "12000"):
        snap = f".cache/g19_pw1024_s{st}.safetensors"
        log = f".cache/gen{GEN}_{cand}.log"
