"""v110-step3 factor graph training driver — calibration-driven Goldilocks."""
import gc
import os
import sys
import time
...
from mycelium.factor_graph_v110_step3 import (
    ...
    attach_fg_params_v110_step3, fg_v110_step3_parameters, fg_v110_step3_state_dict,
    _compile_jit_fg_step_v110_step3, _compile_jit_fg_eval_v110_step3,
)
...
collect_fg_params_v110_step3 = collect_fg_params_v110_acc
model_state_dict_v110_step3 = model_state_dict_v110_acc
load_ckpt_v110_step3 = load_ckpt_v110_acc
evaluate_v110_step3 = evaluate_v110_acc
...
def main():
    ...
    CKPT_LABEL = getenv("CKPT_LABEL",              "v110_step3_smoke")
    ...
    print(f"=== v110-step3 factor graph training (calibration-driven Goldilocks) ===")
    ...
    params   = collect_fg_params_v110_step3(model)
    ...
    if RESUME_FROM:
        ...
        load_ckpt_v110_step3(model, RESUME_FROM)
    ...
    step_fn = _compile_jit_fg_step_v110_step3(
    ...
    for step in range(1, STEPS + 1):
        ...
        if step % CKPT_EVERY == 0:
            ...
            safe_save(model_state_dict_v110_step3(model), ckpt_path)
