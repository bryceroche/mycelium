...
env DEV=AMD ALG2=1 ALG_FTYPES=9 ALG_DUP=1 ALG_HW=512 ALG_WIDE=1 \
    ALG_BREATH=7 ALG_NOTEBOOK=1 ALG_SIXWAVE=1 ALG_OPCOUNT=1 ALG_ALLOW_PEN_TRAIN=1 \
    ...
    ALG_CKPT=.cache/gsb227_opc.safetensors STEPS=${STEPS:-4000} LR=1e-5 BATCH=8 SEED=170 SNAP_EVERY=0 \
