...
json.dump({"n":len(r),"n_single":len(single),"fp":fp,"catch":catch,
           "agree":agree,"verdict":v,"rows":r},
          open(".cache/trigger_license_v2.json","w"),indent=0)
print("[saved] .cache/trigger_license_v2.json (per-row banked)")
