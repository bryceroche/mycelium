#!/bin/bash
# CFG α sweep on v60-take-2 step 6000. Tests α ∈ {1.5, 2.0, 3.0}.

set -e
cd "$(dirname "$0")/.."

# v60-take-2 architecture (NOTEBOOK_DAG=0)
...
for ALPHA in 1.5 2.0 3.0; do
    echo
    echo "=============================================="
    echo "=== CFG_ALPHA=$ALPHA ==="
    echo "=============================================="
    export CFG_ALPHA=$ALPHA
    export DIAG_OUT=/tmp/cfg_v60_alpha${ALPHA}.jsonl
    /home/bryce/mycelium/.venv/bin/python scripts/eval_v60_cfg.py 2>&1 | tail -15
done
