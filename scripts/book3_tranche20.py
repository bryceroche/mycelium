"""book3_tranche20.py — BOOK 3, TRANCHE 20 (sonnet L3 round 4, sealed 8/9): THE FIRST OP-GRAIN TRANCHE
...
T1 = [
 (150, 300, D + "a, b, c, d, e. a is 12. b is 20. a plus b equals c. d is 30. c exceeds d by e. What is e?"),
 (152, 300, D + "a, b, c, d, e. a is 24. b is 10. a exceeds b by c. d is 11. c plus d equals e. What is e?"),
 (153, 300, D + "a, b. a is 100. When a is divided by 2, the quotient is b. What is b?"),
]
OP_SPANS = {
 150: [("addf", "Twelve students in Mrs. Stephenson's class have brown eyes. Twenty students in the class have a lunch box."), ("addf", "Of Mrs. Stephenson's 30 students, what is the least possible number")],
 152: [("addf", "Ten students are taking both algebra and drafting. There are 24 students taking algebra."), ("addf", "There are 11 students who are taking drafting only.")],
 153: [("fr", "$x - 2x + 3x = 100$")],
}
...
for ti, (li, m, dia) in enumerate(T1):
    ...
    texts = [dia] + [permuted_view(dia, 99997 + 100*ti + k) for k in range(1, 5)]
    votes = []
    ...
    if ok:
        banked.append(dict(lane_idx=li, raw=raw, dialect=dia, answer=gold,
                           m=m, lane=row["lane"], book=3, tranche=20,
