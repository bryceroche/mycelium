"""gen14_verdict.py — the manifest-writing verdict (2026-07-13; the law's
...
Usage: gen14_verdict.py <chain-log-path>
"""
...
print("=== GEN-14 VERDICT (mechanical) ===")
for n, v, b in BARS:
...
m.update({
    "gen_id": "14", "date": "2026-07-13",
    "parser_ckpt": ".cache/phase1_gen14_head.safetensors",
    "corpora": {"train": ".cache/algebra_mixed13_train.jsonl",
...
m["hashes"]["parser"] = fh(".cache/phase1_gen14_head.safetensors")
m["hashes"]["train"] = fh(".cache/algebra_mixed13_train.jsonl")
