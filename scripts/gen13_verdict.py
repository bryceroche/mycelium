"""gen13_verdict.py — the manifest-writing verdict (2026-07-13; the law's
...
Usage: gen13_verdict.py <chain-log-path>
"""
...
print("=== GEN-13 VERDICT (mechanical) ===")
for n, v, b in BARS:
...
m.update({
    "gen_id": "13", "date": "2026-07-13",
    "parser_ckpt": ".cache/phase1_gen13_head.safetensors",
...
m["hashes"]["parser"] = fh(".cache/phase1_gen13_head.safetensors")
