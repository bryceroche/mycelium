...
for cand in ("W",):
    ...
    for fx, bmin in BAND_MIN.items():
        pts = [vals[fx]] + [answer_of(f"band_{st}_{fx}") for st in ("8000", "12000")]
        bands[fx] = pts
        if min(pts) < bmin:
...
m["gen_id"] = "17"
m["date"] = "2026-07-23"
m["parser_ckpt"] = ".cache/g19_pw1024.safetensors"
m["corpora"]["train"] = ".cache/gen18b_mix.jsonl"
m["env"]["ALG_HW"] = "1024"
...
m["notes"] = (f"2026-07-23 GEN-19 PROMOTED: g19_pw1024 (H_W=1024 pad-warm; "
