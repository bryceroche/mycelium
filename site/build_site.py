...
HOOKS = {
 "2026-09-18-from-nothing-in-an-hour": "A model trained from random weights in sixty-six minutes clears the wild bar on both seeds; the row-level read and a refuted search over graphs beside it.",
 "2026-09-18-the-row-is-the-wall": "A calibrated end-to-end read: every checkpoint of the week solves two to eight wild rows in 311, and why six points of slot gain never reached the row.",
 ...
 "2026-09-07-two-winds": "VERDICT (Sep 8): the flag's first binding is struck — openness goes with correctness on wild; the second binding (uncalibrated deposits) stands; the bag is still unread. With postscript.",
